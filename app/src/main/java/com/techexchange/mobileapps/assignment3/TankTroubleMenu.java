...
import com.techexchange.mobileapps.assignment3.util.SystemUiHider;
 ...
 * @see SystemUiHider
 */
public class TankTroubleMenu extends Activity {
	 ...
	 */
	private static final int AUTO_HIDE_DELAY_MILLIS = 0; //used to be 3000
